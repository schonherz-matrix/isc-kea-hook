...
extern const isc::log::MessageID SCHMATRIX_BAD_PORT;
...
extern const isc::log::MessageID SCHMATRIX_MUEB_NOT_FOUND;
extern const isc::log::MessageID SCHMATRIX_NOT_MUEB;
extern const isc::log::MessageID SCHMATRIX_OPEN_DATABASE;
extern const isc::log::MessageID SCHMATRIX_PORT_FOUND;
extern const isc::log::MessageID SCHMATRIX_QUERIED_IP;
extern const isc::log::MessageID SCHMATRIX_SNMP_ERROR;
extern const isc::log::MessageID SCHMATRIX_SNMP_EXCEPT;
extern const isc::log::MessageID SCHMATRIX_SQL_DONE;
extern const isc::log::MessageID SCHMATRIX_SQL_FAILED;
